                ...
                <div class="propert_top_details">
                    ...
                    <div class="property_top_box_sctn">
                      ...
                      <div class="property_top_box_sctn">
                        ...
                        <div class="row" style="margin-top: 16px; margin-left: -10px; margin-right: -10px;">
                            <asp:HyperLink ID="HyperLink1" runat="server" Font-Size="Small" Font-Bold="False"><i class="fa fa-phone"></i>
                            </asp:HyperLink>
                        </div>
