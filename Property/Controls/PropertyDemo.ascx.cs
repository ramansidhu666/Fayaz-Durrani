    ...
    public partial class PropertyDemo : System.Web.UI.UserControl
    {
        ...
        void GetPropertyDetails()
        {
            try
            {
                ...
                HyperLink1.Text = "Appointment";
                string host = HttpContext.Current.Request.Url.Host;
                HyperLink1.NavigateUrl = "~/ScheduleAppointment.aspx?MLSID=" + lblMLS.Text + "&PropertyType=" + Session["PropertySearchType"].ToString();
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string property_url = HttpContext.Current.Request.Url.AbsoluteUri;

                SendMailToAdmin(UserEmailId, property_url);
                SendMailToUser(txtEmail.Text);
        ...
        public void SendMailToAdmin(string UserEmailId, string property_url)
        {
            ...
            body = body += "<p>Property link : " + property_url + " </p>";
            mail.Body = body;
